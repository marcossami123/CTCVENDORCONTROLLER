...
def main():
    scripts = [
        BASE_DIR / "db_connector" / "fetchdataEMOODMARKET.py",
        BASE_DIR / "LinkCreator" / "LinkCreatorEmood.py",
        BASE_DIR / "ShowHTML" / "ShowHTML_EMOOD.py",
        BASE_DIR / "HTML_Price_Parser" / "HTML_Price_Parser_EMOODMARKET.py",
        BASE_DIR / "Audit" / "PriceComparisonEmoodMarket.py",
    ...
    print("\n✅ Proceso EMOOD finalizado correctamente")
